...
class VotifierTest extends PHPUnit_Framework_TestCase
{
    private $vote = null;
    ...
    {
        $this->vote = new BukkitVotifier\Votifier('manuele.ddns.net',
                                   '8192',
    ...
    {
        $this->assertInstanceOf('BukkitVotifier\Votifier', $this->vote);
    }
